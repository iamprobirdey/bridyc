        ...
        <h4>We can your social media platform</h4>
          <ul v-if="getTheModel === false">
              ...
              <li v-if="socialData.instagram != null">
                    <a :href="socialData.instagram" target="_blank"><span>Instagram</span></a>
              </li>
          ...
          <div v-if="getTheModel">
              <form @submit.prevent="validateForm()">
                    ...
                    >
                        ...
                        <span v-show="errors.has('facebook')" class="text-danger">{{ errors.first('facebook') }}</span>
                        <span v-show="serverErrors.facebook != ''" class="text-danger">{{ serverErrors.facebook }}</span>
                    </div>
                    ...
                    >
                        ...
                        <span v-show="errors.has('linkedIn')" class="text-danger">{{ errors.first('linkedIn') }}</span>
                        <span v-show="serverErrors.linkedIn != ''" class="text-danger">{{ serverErrors.linkedIn }}</span>
                    </div>

        ...
        <div>
            <ul>
                <li v-for="(image,index) in channelData.college_image" :key="index">
                    <img :src="domainUrl+'/media/channel/'+userId+'/college/'+image.image_path" height="120" width="120" alt="">
                </li>
            </ul>
        </div>
        <button v-if="!collegeImageEntry" class="btn btn-primary" @click="insertImage()">Insert image for your College </button>

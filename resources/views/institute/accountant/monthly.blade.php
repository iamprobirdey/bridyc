...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-lg-10 ml-lg-auto">
            ...
            <br>
            <div class="container">
                <div id="channel-accountant-admission-monthly">
                    <channel-accountant-admission-monthly :channelid="{{json_encode(auth()->user()->channel->id)}}"
                        :admission="{{json_encode($admission)}}" :ledger="{{json_encode($ledger)}}"
                        :monthly="{{json_encode($monthly)}}">
                    </channel-accountant-admission-monthly>
                </div>
            </div>
        </main>
    </div>
...
<script src="{{url('js/ChannelAccountantAdmissionMonthly.js')}}"></script>

...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-lg-10 ml-lg-auto">
            ...
            <br>
            <div class="container">
                <div id="channel-accountant-ledger">
                    <channel-accountant-ledger :channelid="{{json_decode(auth()->user()->channel->id)}}">
                    </channel-accountant-ledger>
                </div>
            </div>
        </main>
    </div>
...
<script src="{{url('js/ChannelAccountantLedger.js')}}"></script>

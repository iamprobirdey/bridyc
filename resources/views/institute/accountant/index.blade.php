        ...
        <main role="main" class="col-lg-10 ml-lg-auto">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center noneTextD">
                    <div class="col-md-3 m-1 customBgcolor" style="height: 200px;">
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{route('channel.accountant.ledger',$channelTitle)}}" class="h5 td-n">Create Ledger</a>
                        ...
                        <div class="d-flex justify-content-between customMT">
                            <a href="{{route('channel.accountant.ledger',$channelTitle)}}">
                                <button type="button" class="btn btn-sm btn-outline-secondary">Add new</button></a>
                            <a href="{{route('channel.accountant.ledger',$channelTitle)}}">
                                <button type="button" class="btn btn-sm btn-primary">View</button></a>
                        </div>
                    </div>
                    <div class="col-md-3 m-1 customBgcolor1" style="height: 200px;">
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{route('channel.accountant.cashbook',$channelTitle)}}" class="h5 td-n">Cashbook</a>
                            <svg xmlns="http://www.w3.org/2000/svg" style="height: 24px;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>
                    ...
                    <div class="col-md-3 m-1 customBgcolor2" style="height: 200px;">
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{route('channel.accountant.admission',$channelTitle)}}" class="h5 td-n">Admission</a>
                            <svg xmlns="http://www.w3.org/2000/svg" style="height: 24px;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>

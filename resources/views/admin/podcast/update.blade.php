...
<div class="card">
    <div class="card-header">podcast Updating</div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.podcast.update',$podcast->id) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <span class="text-danger">Image need to be inserted</span>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="thumbnail" type="text" class="form-control @error('thumbnail') is-invalid @enderror"
                        name="thumbnail" value="{{ $podcast['thumbnail'] }}" required autocomplete="thumbnail"
                        autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                        value="{{ $podcast['name'] }}" required autocomplete="name" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="designation" type="text" class="form-control @error('designation') is-invalid @enderror"
                        name="designation" value="{{ $podcast['designation'] }}" required autocomplete="designation"
                        autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="summary" type="text" class="form-control @error('summary') is-invalid @enderror"
                        name="summary" value="{{ $podcast['summary'] }}" required autocomplete="summary" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="youtube_link" type="text"
                        ...
                        value="{{ $podcast['youtube_link'] }}" required autocomplete="youtube_link" autofocus>

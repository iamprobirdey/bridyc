...
<div class="card">
    <div class="card-header">Standard creating</div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.standard.create') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="standard" type="text" class="form-control @error('standard') is-invalid @enderror"
                        name="standard" value="{{ old('standard') }}" required autocomplete="standard" autofocus>
            ...
            <div class="form-group row">
                <label for="standard" class="col-md-4 col-form-label text-md-right">{{ __('Code') }}</label>

                <div class="col-md-6">
                    <input id="standard" type="text" class="form-control @error('code') is-invalid @enderror"

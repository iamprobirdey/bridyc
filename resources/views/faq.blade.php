    ...
    <div id="accordion">
        <div class="card">
            ...
            <div id="faq1" class="collapse show" data-parent="#accordion">
                <div class="card-body">
                    bridYC is an education hub where students/parents can do proper research about different
                    schools/colleges/kindergarten aided by reviews and complete the admission process online.
                </div>
            </div>
        </div>
        <br>
        <div class="card">
            <div class="card-header faqQ">
                <a class="card-link" data-toggle="collapse" href="#faq2">
                    Is it just another institute listing site? <i class="fa fa-angle-down float-right"
                        aria-hidden="true"></i>
                </a>
            </div>
        ...
        <div class="card">
            <div class="card-header faqQ">
                <a class="card-link" data-toggle="collapse" href="#faq3">
                    Is sign up mandatory to use bridyc.com? <i class="fa fa-angle-down float-right"
                        aria-hidden="true"></i>
                </a>
            </div>

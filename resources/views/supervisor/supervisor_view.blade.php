    ...
    <div class="printBox ">
        <div class="row justify-content-between">
            ...
            <div class="col-sm-6 col-8 col-md-8">
                ...
                <div class="mb-0 d-flex ml-tcenter">
        ...
        <div class=" mt-5">
            ...
            <table class="table f-md table-bordered">
                <tr>
            ...
            <div class="table f-md table-bordered ">
                <div class="row mt-2 ">
            ...
            <table class="table table-bordered f-md">
                <tbody>
                    <tr>
            ...
            <div class="row">
                ...
                <table class="table col-8 f table-borderless">
                    <tbody>
                        <tr>
                            <td>অংকুৰ, মুকুল</td>
                            <td>

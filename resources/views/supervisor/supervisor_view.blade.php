...
<div class="container">
    <form class="form-horizontal ">
        <div class="form-row">
            <div class="form-group col-md-12">
                <label for="inputEmail4 letMePutOneColor">Niketan Name</label>
        ...
        <table class="table table-bordered table-responsive">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" v-validate="'required|numeric'" name="muslim_female"
                            placeholder="" value="{{$form_data->step5->muslim_female}}" />

                    </td>
                    <td>
                        <input type="number" class="form-control" v-validate="'required|numeric'" name="muslim_total"
                            value="{{$form_data->step5->muslim_total}}" placeholder="" />
                ...
                <tr>
                    ...
                    <td>(খ) খ্ৰীষ্টান</td>
                    <td>
                        <input type="number" class="form-control" v-validate="'required|numeric'" name="chritian_male"
                            value="{{$form_data->step5->chritian_male}}" placeholder="" />

                    </td>
                    <td>
                        <input type="number" class="form-control" v-validate="'required|numeric'" name="chritian_female"
                            value="{{$form_data->step5->chritian_female}}" placeholder="" />

                    </td>
                    <td>
                        <input type="number" class="form-control" v-validate="'required|numeric'" name="chritian_total"
                            value="{{$form_data->step5->chritian_total}}" placeholder="" />
    ...
    <form>
        ...
        <div class="p-2 row">
            ...
            <input type="text" class="form-control col-1 mr-2" v-model="step6.one" v-validate="'required'" name="one"
                value="{{$form_data->step6->one}}" placeholder="নিকেতনখন ....." />

            <p class="mt-2 mr-2">নগৰীয়া বস্তিৰ সংখ্যা</p>
            <input type="text" class="form-control col-1 mr-2" v-model="step6.two" v-validate="'required'" name="two"
                value="{{$form_data->step6->two}}" placeholder="নগৰীয়া বস্তিৰ সংখ্যা" />
        ...
        <div class="p-2 row">
            ...
            <input type="text" class="form-control col-2 mr-2" v-model="step6.nine" v-validate="'required'" name="nine"
                placeholder="অধিকতম মানধন" value="{{$form_data->step6->nine}}" />
    ...
    <form>
        <div class="p-2 row">
            ...
            <input type="text" class="form-control col-2 mr-2" v-model="step7.one" v-validate="'required'" name="one"
                value="{{$form_data->step7->one}}" placeholder="" />

            <p class="mt-2 mr-2">
                স্থানীয় সমিতিৰ পৰা পোৱা নিযুক্তিৰ তাৰিখ </p>
            <input type="text" class="form-control col-2 mr-2" v-model="step7.two" v-validate="'required'" name="two"
                placeholder="" value="{{$form_data->step7->two}}" />
            ...
            <input type="text" class="form-control col-2 mr-2" v-model="step7.four" v-validate="'required'" name="four"
                placeholder="" value="{{$form_data->step7->four}}" />

            <p class="mt-2 mr-2">প্রধানাচাৰ্য প্ৰশিক্ষণ লোৱা চন </p>
            <input type="text" class="form-control col-2 mr-2" v-model="step7.five" v-validate="'required'" name="five"
                placeholder="" value="{{$form_data->step7->five}}" />
        ...
        <div class="p-2 row">
            ...
            <input type="text" class="form-control col-2 mr-2" v-model="step7.six" v-validate="'required'" name="six"
                placeholder="" value="{{$form_data->step7->six}}" />
        ...
        <div class="p-2 row">
            ...
            <input type="text" class="form-control col-2 mr-2" v-model="step7.nine" v-validate="'required'" name="nine"
                placeholder="" value="{{$form_data->step7->nine}}" />
        ...
        <div class="p-2 row">
            ...
            <input type="text" class="form-control col-2 mr-2" v-model="step7.ten" v-validate="'required'" name="ten"
                placeholder="" value="{{$form_data->step7->ten}}" />
    ...
    <form>
        ...
        <div class="p-2 row">
            ...
            <input type="text" class="form-control col-2 mr-2" v-model="step8.one" v-validate="'required'" name="one"
                value="{{$form_data->step8->one}}" placeholder="" />

            <p class="mt-2 mr-2">
                (ক) আবেদন কৰিছে (খ) নিকেতন খোলাৰ অনুমতি হৈছে (গ) যদি চৰকাৰী পঞ্জীভূক্ত
                হৈছে, পঞ্জীয়ন নম্বৰ দিব
            </p>
            <input type="text" class="form-control col-2 mr-2" v-model="step8.two" v-validate="'required'" name="two"
                placeholder="" value="{{$form_data->step7->two}}" />
        ...
        <div class="p-2 row">
            <p class="mt-2 mr-2">৭ । (ক) পঞ্জীয়নৰ বাবে চৰকাৰৰ সৈতে হোৱা যোগাযোগ</p>
            <input type="text" class="form-control col-2 mr-2" v-model="step8.four" v-validate="'required'" name="four"
                placeholder="3" value="{{$form_data->step7->four}}" />

            <p class="mt-2 mr-2">
                (ক) আবেদন কৰিছে (খ) নিকেতন খোলাৰ অনুমতি হৈছে (গ) যদি চৰকাৰী পঞ্জীভূক্ত
                হৈছে, পঞ্জীয়ন নম্বৰ দিব
            </p>
            <input type="text" class="form-control col-2 mr-2" v-model="step8.five" v-validate="'required'" name="five"
                placeholder="3" value="{{$form_data->step7->five}}" />

            <p class="mt-2 mr-2">
                (ঘ) কোনো ধৰণৰ যোগাযোগ হোৱা নাই । সেৱাৰ কড নম্বৰ দিব
            </p>
            <input type="text" class="form-control col-2 mr-2" v-model="step8.six" v-validate="'required'" name="six"
                placeholder="3" value="{{$form_data->step7->six}}" />
        ...
        <div class="p-2 row">
            ...
            <input type="text" class="form-control col-2 mr-2" v-model="step8.nine" v-validate="'required'" name="nine"
                placeholder="3" value="{{$form_data->step7->nine}}" />
        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.one_start_date" v-validate="'required'"
                            name="one_start_date" placeholder="" value="{{$form_data->step9->one_start_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.one_15_diniya" v-validate="'required'"
                            name="one_15_diniya" placeholder="" value="{{$form_data->step9->one_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.two_start_date" v-validate="'required'"
                            name="two_start_date" placeholder="" value="{{$form_data->step9->two_start_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.two_15_diniya" v-validate="'required'"
                            name="two_15_diniya" placeholder="" value="{{$form_data->step9->two_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.three_start_date" v-validate="'required'"
                            name="three_start_date" placeholder="" value="{{$form_data->step9->three_start_date}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.three_end_date" v-validate="'required'"
                            name="three_end_date" placeholder="" value="{{$form_data->step9->three_end_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.three_pathdam" v-validate="'required'"
                            name="three_pathdam" placeholder="" value="{{$form_data->step9->three_pathdam}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.three_7_diniya" v-validate="'required'"
                            name="three_7_diniya" placeholder="" value="{{$form_data->step9->three_7_diniya}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.three_15_diniya" v-validate="'required'"
                            name="three_15_diniya" placeholder="" value="{{$form_data->step9->three_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.four_start_date" v-validate="'required'"
                            name="four_start_date" placeholder="" value="{{$form_data->step9->four_start_date}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.four_end_date" v-validate="'required'"
                            name="four_end_date" placeholder="" value="{{$form_data->step9->four_end_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.four_7_diniya" v-validate="'required'"
                            name="four_7_diniya" placeholder="" value="{{$form_data->step9->four_7_diniya}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.four_15_diniya" v-validate="'required'"
                            name="four_15_diniya" placeholder="" value="{{$form_data->step9->four_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.five_start_date" v-validate="'required'"
                            name="five_start_date" placeholder="" value="{{$form_data->step9->five_start_date}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.five_end_date" v-validate="'required'"
                            name="five_end_date" placeholder="" value="{{$form_data->step9->five_end_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.five_7_diniya" v-validate="'required'"
                            name="five_7_diniya" placeholder="" value="{{$form_data->step9->five_7_diniya}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.five_15_diniya" v-validate="'required'"
                            name="five_15_diniya" placeholder="" value="{{$form_data->step9->five_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.six_start_date" v-validate="'required'"
                            name="six_start_date" placeholder="" value="{{$form_data->step9->six_start_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.six_15_diniya" v-validate="'required'"
                            name="six_15_diniya" placeholder="" value="{{$form_data->step9->six_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.seven_start_date" v-validate="'required'"
                            name="seven_start_date" placeholder="" value="{{$form_data->step9->seven_start_date}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.seven_end_date" v-validate="'required'"
                            name="seven_end_date" placeholder="" value="{{$form_data->step9->seven_end_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.seven_pathdam" v-validate="'required'"
                            name="seven_pathdam" placeholder="" value="{{$form_data->step9->seven_pathdam}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.seven_7_diniya" v-validate="'required'"
                            name="seven_7_diniya" placeholder="" value="{{$form_data->step9->seven_7_diniya}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.seven_15_diniya" v-validate="'required'"
                            name="seven_15_diniya" placeholder="" value="{{$form_data->step9->seven_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.eight_start_date" v-validate="'required'"
                            name="eight_start_date" placeholder="" value="{{$form_data->step9->eight_start_date}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.eight_end_date" v-validate="'required'"
                            name="eight_end_date" placeholder="" value="{{$form_data->step9->eight_end_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.eight_pathdam" v-validate="'required'"
                            name="eight_pathdam" placeholder="" value="{{$form_data->step9->eight_pathdam}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.eight_7_diniya" v-validate="'required'"
                            name="eight_7_diniya" placeholder="" value="{{$form_data->step9->eight_7_diniya}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.eight_15_diniya" v-validate="'required'"
                            name="eight_15_diniya" placeholder="" value="{{$form_data->step9->eight_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.nine_start_date" v-validate="'required'"
                            name="nine_start_date" placeholder="" value="{{$form_data->step9->nine_start_date}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.nine_end_date" v-validate="'required'"
                            name="nine_end_date" placeholder="" value="{{$form_data->step9->nine_end_date}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.nine_7_diniya" v-validate="'required'"
                            name="nine_7_diniya" placeholder="" value="{{$form_data->step9->nine_7_diniya}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.nine_15_diniya" v-validate="'required'"
                            name="nine_15_diniya" placeholder="" value="{{$form_data->step9->nine_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td> <input type="text" class="form-control" v-model="step9.ten_start_date" v-validate="'required'"
                            name="ten_start_date" placeholder="" value="{{$form_data->step9->ten_start_date}}" />

                    <td> <input type="text" class="form-control" v-model="step9.ten_end_date" v-validate="'required'"
                            name="ten_end_date" placeholder="" value="{{$form_data->step9->ten_end_date}}" />
                    ...
                    <td> <input type="text" class="form-control" v-model="step9.ten_7_diniya" v-validate="'required'"
                            name="ten_7_diniya" placeholder="" value="{{$form_data->step9->ten_7_diniya}}" />
                    <td> <input type="text" class="form-control" v-model="step9.ten_15_diniya" v-validate="'required'"
                            name="ten_15_diniya" placeholder="" value="{{$form_data->step9->ten_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.eleven_end_date" v-validate="'required'"
                            name="eleven_end_date" placeholder="" value="{{$form_data->step9->eleven_end_date}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.eleven_mohila" v-validate="'required'"
                            name="eleven_mohila" placeholder="" value="{{$form_data->step9->eleven_mohila}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.eleven_nondor" v-validate="'required'"
                            name="eleven_nondor" placeholder="" value="{{$form_data->step9->eleven_nondor}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.eleven_pathdam" v-validate="'required'"
                            name="eleven_pathdam" placeholder="" value="{{$form_data->step9->eleven_pathdam}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.eleven_7_diniya" v-validate="'required'"
                            name="eleven_7_diniya" placeholder="" value="{{$form_data->step9->eleven_7_diniya}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.eleven_15_diniya" v-validate="'required'"
                            name="eleven_15_diniya" placeholder="" value="{{$form_data->step9->eleven_15_diniya}}" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.twelve_end_date" v-validate="'required'"
                            name="twelve_end_date" placeholder="" value="{{$form_data->step9->twelve_end_date}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.twelve_mohila" v-validate="'required'"
                            name="twelve_mohila" placeholder="" value="{{$form_data->step9->twelve_mohila}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.twelve_nondor" v-validate="'required'"
                            name="twelve_nondor" placeholder="" value="{{$form_data->step9->twelve_nondor}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.twelve_pathdam" v-validate="'required'"
                            name="twelve_pathdam" placeholder="" value="{{$form_data->step9->twelve_pathdam}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.twelve_7_diniya" v-validate="'required'"
                            name="twelve_7_diniya" placeholder="" value="{{$form_data->step9->twelve_7_diniya}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.twelve_15_diniya" v-validate="'required'"
                            name="twelve_15_diniya" placeholder="" value="{{$form_data->step9->twelve_15_diniya}}" />
                ...
                <tr>
                    <td>১৩</td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.thirteen_name" v-validate="'required'"
                            name="thirteen_name" placeholder="" value="{{$form_data->step9->thirteen_name}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.thirteen_mohila" v-validate="'required'"
                            name="thirteen_mohila" placeholder="" value="{{$form_data->step9->thirteen_mohila}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.thirteen_nondor" v-validate="'required'"
                            name="thirteen_nondor" placeholder="" value="{{$form_data->step9->thirteen_nondor}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.thirteen_ahota" v-validate="'required'"
                            name="thirteen_ahota" placeholder="" value="{{$form_data->step9->thirteen_ahota}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.thirteen_pathdam" v-validate="'required'"
                            name="thirteen_pathdam" placeholder="" value="{{$form_data->step9->thirteen_pathdam}}" />
                ...
                <tr>
                    <td>১৪</td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.fourteen_name" v-validate="'required'"
                            name="fourteen_name" placeholder="" value="{{$form_data->step9->fourteen_name}}" />
                    ...
                    <td>
                        <input type="text" class="form-control" v-model="step9.fourteen_mohila" v-validate="'required'"
                            name="fourteen_mohila" placeholder="" value="{{$form_data->step9->fourteen_mohila}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.fourteen_nondor" v-validate="'required'"
                            name="fourteen_nondor" placeholder="" value="{{$form_data->step9->fourteen_nondor}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.fourteen_ahota" v-validate="'required'"
                            name="fourteen_ahota" placeholder="" value="{{$form_data->step9->fourteen_ahota}}" />

                    </td>
                    <td>
                        <input type="text" class="form-control" v-model="step9.fourteen_pathdam" v-validate="'required'"
                            name="fourteen_pathdam" placeholder="" value="{{$form_data->step9->fourteen_pathdam}}" />

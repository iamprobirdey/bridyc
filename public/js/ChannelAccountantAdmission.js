...
/* harmony import */ var _EditChannel_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./EditChannel.vue */ "./resources/js/components/EditChannel.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getClassData: function getClassData() {
      ...
      axios.get("/api/channel/get/accountant/class/data").then(function (response) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _channel_board_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../channel/board.vue */ "./resources/js/components/channel/board.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    firstStep: function firstStep(scope) {
      ...
      this.$validator.validate(scope).then(function (result) {
        if (result) {
          _this2.step = 1;
        } else {
    ...
    submitForm: function submitForm() {
      ...
      this.$validator.validate().then(function (result) {
        if (result) {
          axios.post("/api/channel/accountant/admission/data/" + _this3.channelId, _this3.admissionFormData).then(function (response) {
            ...
            if (response.data.message === true) {
              ...
              _this3.admissionFormData.admission_number = "";
              _this3.admissionFormData.name = "";
              _this3.admissionFormData.roll_number = "";
              _this3.admissionFormData.phone = "";
              _this3.admissionFormData.father_name = "";
              _this3.admissionFormData.category = "";

              _this3.$emit("pass-admission-data-to-parent", response.data.data);
            }
            ...
            if (errors.response.data.errors.admission_number) {
              _this3.serverError.admission_number = errors.response.data.errors.admission_number[0];
            }

            if (errors.response.data.errors.name) {
              _this3.serverError.name = errors.response.data.errors.name[0];
            }

            if (errors.response.data.errors.roll_number) {
              _this3.serverError.roll_number = errors.response.data.errors.roll_number[0];
            }

            if (errors.response.data.errors.phone) {
              _this3.serverError.phone = errors.response.data.errors.phone[0];
            }

            if (errors.response.data.errors.father_name) {
              _this3.serverError.father_name = errors.response.data.errors.father_name[0];
            }

            if (errors.response.data.errors.category) {
              _this3.serverError.category = errors.response.data.errors.category[0];
            }
          });
        }
      });

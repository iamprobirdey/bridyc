...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {},
  methods: {
    addAvatarImageFile: function addAvatarImageFile() {
      ...
      if (input.files && input.files[0]) {
        ...
        if (validImageTypes.includes(input.files[0]["type"])) {
          ...
          reader.onload = function (e) {
            _this.coppieAvatarImageData = e.target.result;
          };
    ...
    uploadImage2: function uploadImage2() {
      ...
      if (canvas) {
        ...
        canvas.toBlob(function (blob) {
          ...
          form.append("height", _this2.coordinateAvatarHeight);
          form.append("width", _this2.coordinateAvatarWidth);
          _this2.wait = true;
          axios.post("/api/profile/avatar", form, {
            emulateJSON: true
          }).then(function (response) {
            _this2.userImage = response.data.image;
            _this2.wait = false;
            _this2.coppieAvatarImageData = "";
            $("#addImageCroppieAvatar").modal("hide");
          })["catch"](function (errors) {
            _this2.wait = false;
            ...
            _c("div", { staticClass: "modal-content" }, [
              _c("div", { staticClass: "modal-body my-n3" }, [
                _c("div", [
                  ...
                  _vm._v(" "),
                  _vm.croppieAvatarImageValidation != ""
                    ? _c("p", {
                        staticClass: "text-danger",
                        domProps: {
                          innerHTML: _vm._s(_vm.croppieAvatarImageValidation)
                        }
                      })
                    : _vm._e()
                ])
              ...
              _c(
                ...
                [
                  _c("cropper", {
                    ...
                    attrs: { src: _vm.coppieAvatarImageData },
                  ...
                  _c(
                    "button",
                    {
                      ...
                      on: { click: _vm.addAvatarImageFile }
                    },
                    [_vm._v("\n            Change Image\n          ")]
                  )
                ],
